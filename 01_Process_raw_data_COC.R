...
saveRDS(consobskeep, file=(str_c(outputs_path, 'consobskeep.rds')))


## Load patient data
pats <- opendt(all_data[20])
...
saveRDS(pats_incl, file=str_c(outputs_path, 'pats_incl.rds'))
...
saveRDS(countcons, file=(str_c(outputs_path, 'countcons.rds')))
